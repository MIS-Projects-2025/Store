...
export default function Consumable({ tableData, tableFilters, empStation = 1 }) {
    ...
    const handleSaveEditDetail = (detail) => {
        ...
        router.put(route('consumable.bulkUpdateDetails'), { details: [payload] }, {
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => {
                setEditingDetailId(null);
        ...
        <AuthenticatedLayout>
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="btn btn-outline" onClick={() => setIsQuantityModalOpen(true)}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <table className="table table-zebra w-full [&_th]:border-y [&_th]:border-base-content/20 [&_td]:border-y [&_td]:border-base-content/20">
                        ...
                        <tbody>
                            {consumableItems.length > 0 ? (
                                    ...
                                    if (details.length === 0) {
                                        return (
                                            <tr key={`empty-${item.consumable_id}`}>
                                                <td colSpan="10" className="opacity-50 italic">
                                        ...
                                        return (
                                            <tr key={`${item.consumable_id}-${detail.id}`}>
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        station === 1 ? (
                                                            <input type="text" name="item_code" className="input input-bordered input-xs w-full" value={editDetailFormData.item_code} onChange={handleEditDetailInputChange} />
                                                        ) : (
                                                            <span className="opacity-50">{detail.item_code || '-'}</span>
                                                        )
                                                    ) : (
                                                        detail.item_code || '-'
                                                    )}
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        station === 1 ? (
                                                            <input type="text" name="detailed_description" className="input input-bordered input-xs w-full" value={editDetailFormData.detailed_description} onChange={handleEditDetailInputChange} />
                                                        ) : (
                                                            <span className="opacity-50">{detail.detailed_description || '-'}</span>
                                                        )
                                                    ) : (
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        station === 1 ? (
                                                            <input type="text" name="serial" className="input input-bordered input-xs w-full" value={editDetailFormData.serial} onChange={handleEditDetailInputChange} />
                                                        ) : (
                                                            <span className="opacity-50">{detail.serial || '-'}</span>
                                                        )
                                                    ) : (
                                                        detail.serial || '-'
                                                    )}
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        <input type="text" name="bin_location" className="input input-bordered input-xs w-full" value={editDetailFormData.bin_location} onChange={handleEditDetailInputChange} />
                                                    ) : (
                                                        detail.bin_location || '-'
                                                    )}
                                                </td>
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        station === 1 ? (
                                                            <input type="number" name="quantity" className="input input-bordered input-xs w-20" value={editDetailFormData.quantity} onChange={handleEditDetailInputChange} />
                                                        ) : (
                                                            <span className="opacity-50">{detail.quantity || '0'}</span>
                                                        )
                                                    ) : (
                                                        detail.quantity || '0'
                                                    )}
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        station === 1 ? (
                                                            <input type="number" name="min" className="input input-bordered input-xs w-20" value={editDetailFormData.min} onChange={handleEditDetailInputChange} />
                                                        ) : (
                                                            <span className="opacity-50">{detail.min || '0'}</span>
                                                        )
                                                    ) : (
                                                        detail.min || '0'
                                                    )}
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        station === 1 ? (
                                                            <input type="number" name="max" className="input input-bordered input-xs w-20" value={editDetailFormData.max} onChange={handleEditDetailInputChange} />
                                                        ) : (
                                                            <span className="opacity-50">{detail.max || '0'}</span>
                                                        )
                                                    ) : (
                                                        detail.max || '0'
                                                    )}
                                                ...
                                                <td>
                                                    <div className="flex justify-center gap-1">
                                                        {isEditing ? (
                                                            <>
                                                                <button className="btn btn-xs btn-outline" onClick={() => handleSaveEditDetail(detail)} title="Save">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                                                                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                                                    </svg>
                                                                </button>
                                                                <button className="btn btn-xs btn-ghost" onClick={handleCancelEditDetail} title="Cancel">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                                                                        <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                                                                    </svg>
                                                                </button>
                                                            ...
                                                            <>
                                                                {isFirstDetail && (
                                                                    <button className="btn btn-xs btn-outline" title="Add Detail to this Item" onClick={() => handleAddItemToExisting(item)}>
                                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                                                                            <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                                                                        </svg>
                                                                    </button>
                                                                )}
                                                                <button className="btn btn-xs btn-ghost" title="View Detail History" onClick={() => handleViewDetailHistory(detail)}>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                                                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                                                                    </svg>
                                                                </button>
                                                                <button className="btn btn-xs btn-ghost" title="Edit Detail" onClick={() => handleEditDetailClick(detail)}>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                                                                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                                                    </svg>
                                                                </button>
                                                                <button className="btn btn-xs btn-ghost opacity-60 hover:opacity-100 hover:text-error" title="Delete Detail" onClick={() => handleDeleteDetailClick(detail)}>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                                                                        <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" />
                                                                    </svg>
                                                                </button>
                                ...
                                <tr>
                                    <td colSpan="11" className="text-center py-8 opacity-50">
                    ...
                    <div className="flex justify-center">
                        <div className="join">
                            <button
                                ...
                                onClick={() => router.get(route('consumable'), { page: pagination.current_page - 1, per_page: pagination.per_page, search: mainSearchQuery }, { preserveState: true, preserveScroll: true })}
                            >«</button>
                                ...
                                if (page === 1 || page === pagination.last_page || (page >= pagination.current_page - 1 && page <= pagination.current_page + 1)) {
                                    return (
                                        <button
                                            ...
                                            onClick={() => router.get(route('consumable'), { page, per_page: pagination.per_page, search: mainSearchQuery }, { preserveState: true, preserveScroll: true })}
                                        >{page}</button>
                                    );
                    ...
                    <div className="modal-box">
                        ...
                        {isAddingToExisting && (
                            <div className="flex items-center gap-3 border border-base-content/20 rounded-lg p-3 mb-4">
                                ...
                                <span className="text-sm opacity-70">Adding detail to consumable ID: {existingConsumableId}</span>
                            </div>
                        )}

                        <div className="space-y-4">
                            <div className="form-control">
                                <label className="label"><span className="label-text">Material Description *</span></label>
                                <input type="text" name="material_description" placeholder="Enter material description" className="input input-bordered w-full" value={formData.material_description} onChange={handleInputChange} disabled={isAddingToExisting} />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Category *</span></label>
                                <input type="text" name="category" placeholder="Enter category" className="input input-bordered w-full" value={formData.category} onChange={handleInputChange} disabled={isAddingToExisting} />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Unit of Measure (UOM) *</span></label>
                                <input type="text" name="uom" placeholder="e.g., pcs, kg, box" className="input input-bordered w-full" value={formData.uom} onChange={handleInputChange} disabled={isAddingToExisting} />
                            </div>
                        </div>
                ...
                <div className="modal modal-open">
                    <div className="modal-box max-w-2xl">
                        ...
                        {isAddingToExisting && (
                            <div className="border border-base-content/20 rounded-lg p-3 mb-4">
                                <div className="flex items-start gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="shrink-0 w-5 h-5 opacity-60 mt-0.5" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <div className="text-sm opacity-70">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="form-control">
                                <label className="label"><span className="label-text">Item Code *</span></label>
                                <input type="text" name="item_code" placeholder="Enter item code" className="input input-bordered w-full" value={formData.item_code} onChange={handleInputChange} required />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Long Description</span></label>
                                <input type="text" name="detailed_description" placeholder="Enter Long Description" className="input input-bordered w-full" value={formData.detailed_description} onChange={handleInputChange} />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Serial Number</span></label>
                                <input type="text" name="serial" placeholder="Enter serial number" className="input input-bordered w-full" value={formData.serial} onChange={handleInputChange} />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Bin Location</span></label>
                                <input type="text" name="bin_location" placeholder="Enter bin location" className="input input-bordered w-full" value={formData.bin_location} onChange={handleInputChange} />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Quantity *</span></label>
                                <input type="number" name="quantity" placeholder="Enter quantity" className="input input-bordered w-full" value={formData.quantity} onChange={handleInputChange} min="0" step="1" required />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Maximum Quantity</span></label>
                                <input type="number" name="max" placeholder="Enter maximum quantity" className="input input-bordered w-full" value={formData.max} onChange={handleInputChange} min="0" step="1" />
                            </div>
                            <div className="form-control">
                                <label className="label"><span className="label-text">Minimum Quantity</span></label>
                                <input type="number" name="min" placeholder="Enter minimum quantity" className="input input-bordered w-full" value={formData.min} onChange={handleInputChange} min="0" step="1" />
                            </div>
                            {!isAddingToExisting && (
                                <div className="form-control">
                                    <label className="label"><span className="label-text">Price</span></label>
                                    <input type="number" step="0.01" name="price" placeholder="Enter price" className="input input-bordered w-full" value={formData.price} onChange={handleInputChange} min="0" />
                                </div>
                            )}
                        </div>
                        ...
                        <div className="modal-action">
                            {!isAddingToExisting && (
                                <button type="button" className="btn btn-ghost" onClick={() => { setIsSecondModalOpen(false); setIsModalOpen(true); }}>Back</button>
                            )}
                            <button type="button" className="btn btn-ghost" onClick={handleCloseSecondModal}>Cancel</button>
                            <button type="button" className="btn btn-outline" onClick={handleSubmit}>
            ...
            {isQuantityModalOpen && (
                <div className="modal modal-open">
                    <div className="modal-box max-w-5xl">
                                                        ...
                                                        <li key={item.id} className="w-full">
                                                            ...
                                                            >
                                                                <div className="flex justify-between w-full">
                                                                    ...
                                                                    <span className="badge badge-outline badge-sm">{item.consumable?.material_description}</span>
                                                                </div>
                                                                <span className="text-sm opacity-60">Desc: {item.detailed_description}</span>
                                                                <span className="text-xs opacity-50">Category: {item.consumable?.category || '-'}</span>
                                                                <span className="text-xs opacity-50">Current Qty: {item.quantity} {item.consumable?.uom} | Bin: {item.bin_location || 'N/A'}</span>
                                                            </button>
                                                        </li>
                                                    ))}
                                                </ul>
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div className="flex-1">
                                                ...
                                                <div className="grid grid-cols-3 gap-2 text-xs">
                                                    ...
                                                    <div>
                                                        <p className="opacity-50">Current Qty</p>
                                                        <p className="font-medium">{selectedItem.quantity} {selectedItem.consumable?.uom}</p>
                                                    </div>
                                                    <div className="col-span-2">
                                                        <p className="opacity-50">Bin Location</p>
                                                        <p className="font-medium">{selectedItem.bin_location || 'N/A'}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <button className="btn btn-outline btn-sm ml-2" onClick={handleAddToTable}>
                                                Add to Table
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div className="border border-base-content/20 rounded-lg p-4">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    {selectedItems.length > 0 && (
                                        <button className="btn btn-ghost btn-xs" onClick={() => setSelectedItems([])}>
                                            Clear All
                                        </button>
                                    )}
                                </div>
                                                ...
                                                {selectedItems.map((item) => {
                                                    ...
                                                    return (
                                                        <tr key={item.id}>
                                                            ...
                                                            <td>
                                                                <button className="btn btn-ghost btn-xs opacity-60 hover:opacity-100 hover:text-error" onClick={() => handleRemoveFromTable(item.id)}>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                                                        <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                                                                    </svg>
                                                                </button>
                        ...
                        <div className="modal-action">
                            <button className="btn btn-ghost" onClick={() => { setIsQuantityModalOpen(false); setSelectedItems([]); setSelectedItem(null); setQuantitySearchQuery(""); setFilteredItems([]); }}>
                                Cancel
                            </button>
                            <button className="btn btn-outline" onClick={handleAddQuantity} disabled={selectedItems.length === 0 || isAddingQuantity}>
                                {isAddingQuantity ? (
                                    <>
                                        <span className="loading loading-spinner loading-sm mr-2"></span>
                                        Updating...
            ...
            {isDeleteModalOpen && itemToDelete && (
                <div className="modal modal-open">
                    <div className="modal-box">
                        <h3 className="font-bold text-lg mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline-block mr-2 opacity-70" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div className="flex items-start gap-3 border border-base-content/20 rounded-lg p-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm opacity-70">This action cannot be undone. This will permanently delete the item and all its related details.</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text font-semibold">Type <span className="font-bold">CONFIRM</span> to delete:</span>
                                </label>
                                <input
                                    type="text"
                        ...
                        <div className="modal-action">
                            <button className="btn btn-ghost" onClick={handleCloseDeleteModal} disabled={isDeleting}>Cancel</button>
                            <button className="btn btn-outline border-error text-error hover:bg-error hover:text-error-content" onClick={handleConfirmDelete} disabled={deleteConfirmText !== "CONFIRM" || isDeleting}>
                                {isDeleting ? (
                                    <>
                                        <span className="loading loading-spinner loading-sm mr-2"></span>
                                        Deleting...
            ...
            {isHistoryModalOpen && historyItem && (
                <div className="modal modal-open">
                    <div className="modal-box max-w-4xl">
                                    ...
                                    <tbody>
                                        {historyData.map((record, index) => (
                                            <tr key={record.id || index}>
                                                ...
                                                <td>
                                                    <span className="badge badge-outline badge-sm">{record.action}</span>
                                                </td>
                                                <td className="text-xs">{record.user_name}</td>
                                                <td className="text-xs">
                                                    {record.action === 'created' && <span className="opacity-70">Item created</span>}
                                                    {record.action === 'updated' && record.changes && (
                                                        <div className="space-y-1">
                                                            {record.changes.map((field, i) => (
                                                                <div key={i}>
                                                                    <strong>{field}:</strong>
                                                                    <span className="opacity-50 line-through ml-1">{record.old_values?.[field] || 'N/A'}</span>
                                                                    <span className="mx-1">→</span>
                                                                    <span>{record.new_values?.[field] || 'N/A'}</span>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    )}
                                                    {record.action === 'deleted' && <span className="opacity-70">Item deleted</span>}
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
                        ...
                        <div className="modal-action">
                            <button className="btn btn-ghost" onClick={handleCloseHistoryModal}>Close</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            {isDetailHistoryModalOpen && detailHistoryItem && (
                <div className="modal modal-open">
                    <div className="modal-box max-w-5xl">
                        <h3 className="font-bold text-lg mb-4">Detail History: {detailHistoryItem.item_code}</h3>
                                                    ...
                                                    {record.action === 'updated' && record.changes && (
                                                        <div className="space-y-1">
                                                            {record.changes.map((field, i) => (
                                                                <div key={i}>
                                                                    <strong>{field}:</strong>
                                                                    <span className="opacity-50 line-through ml-1">{String(record.old_values?.[field] || 'N/A')}</span>
                                                                    <span className="mx-1">→</span>
                                                                    <span>{String(record.new_values?.[field] || 'N/A')}</span>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    )}
                        ...
                        <div className="modal-action">
                            <button className="btn btn-ghost" onClick={handleCloseDetailHistoryModal}>Close</button>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="modal modal-open">
                    <div className="modal-box">
                        ...
                        <div className="flex items-start gap-3 border border-base-content/20 rounded-lg p-3 mb-4">
                            ...
                            <div>
                                <p className="font-bold text-sm">Warning!</p>
                                <p className="text-sm opacity-70">This action cannot be undone. This will permanently delete this detail.</p>
                            </div>
                        </div>
                        ...
                        <div className="modal-action">
                            <button className="btn btn-ghost" onClick={handleCloseDeleteDetailModal} disabled={isDeletingDetail}>Cancel</button>
                            <button className="btn btn-outline border-error text-error hover:bg-error hover:text-error-content" onClick={handleConfirmDeleteDetail} disabled={deleteDetailConfirmText !== "CONFIRM" || isDeletingDetail}>
                                {isDeletingDetail ? (
                                    <>
                                        <span className="loading loading-spinner loading-sm mr-2"></span>
                                        Deleting...
